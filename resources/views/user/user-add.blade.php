      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 ">
          <div class="x_panel">
            ...
            <div class="x_content">
              <br />
              <form id="form-user" class="form-horizontal form-label-left" action="{{ url('/user-add')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 ">
                    <input type="text" id="email" required="required" class="form-control" name="email">
                  </div>
                </div>
                <div class="item form-group">
